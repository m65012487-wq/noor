...
const styles = StyleSheet.create({
  label: { ...TYPE.body, color: COLORS.accent, fontWeight: '700', marginBottom: SPACING.md },
  row: {
    flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center',
    padding: SPACING.md, borderRadius: RADIUS.md, marginBottom: SPACING.sm,
    backgroundColor: COLORS.surface,
  },
  rowActive: { backgroundColor: COLORS.surfaceActive, borderWidth: 1, borderColor: COLORS.accent },
  rowText: { ...TYPE.body, color: COLORS.cream },
  rowTextActive: { color: COLORS.accent, fontWeight: '700' },
  check: { ...TYPE.subhead, color: COLORS.accent, fontWeight: '900' },
});
