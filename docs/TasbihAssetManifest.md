...
**Текущее подключение:** после отдельного запроса пользователя пять PNG перенесены в `assets/tasbih/tree/` и зарегистрированы в TREE_ASSETS. Размер 1024×1536, contain, alpha сохранён; масштаб seed 1, sprout 0.85, young 0.44, juvenile 0.70, mature 1. Ниже сохранены спецификация SVG и история QA. Цветная дымка исходной генерации не удалена; это известная особенность этих изображений, а не обещание чистого cutout.
