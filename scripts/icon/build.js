...
(async () => {
  ...
  // Заставка: только знак на прозрачном фоне. Цвет подложки задаётся
  // в app.json, поэтому картинку не нужно растягивать под каждую диагональ
  // и на любом экране она остаётся ровно по центру.
  await write('splash.png', 1024, 0.30, false);
})();
